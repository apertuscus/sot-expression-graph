...
#ifndef __SOT_FEATURE_POINT_TO_LINE_PRJ_HH__
#define __SOT_FEATURE_POINT_TO_LINE_PRJ_HH__
...
#    define SOTFeaturePointToLinePrj_EXPORT __declspec(dllexport)
#  else
#    define SOTFeaturePointToLinePrj_EXPORT __declspec(dllimport)
#  endif
#else
#  define SOTFeaturePointToLinePrj_EXPORT
#endif
...
public:
  FeaturePointToLinePrj( const std::string& name );
  virtual ~FeaturePointToLinePrj( void ) {}
