...
DYNAMICGRAPH_FACTORY_ENTITY_PLUGIN(FeatureAnglesBtwPlanes,"FeatureAnglesBtwPlanes");

/* --------------------------------------------------------------------- */
/* --- CLASS ----------------------------------------------------------- */
/* --------------------------------------------------------------------- */

FeatureAnglesBtwPlanes::
FeatureAnglesBtwPlanes( const string& name )
...
, norm2_SIN( NULL,"FeatureAnglesBtwPlanes("+name+")::input(vector)::norm2" )
{
  ...
  Soutput_=Sreference-geometric_primitive::angles_btw_planes(plane1,plane2);
...
unsigned int& FeatureAnglesBtwPlanes::
...
void FeatureAnglesBtwPlanes::updateInputValues(KDL::Expression<double>::Ptr Soutput, int time)
{
...
ml::Matrix& FeatureAnglesBtwPlanes::
 ...
 */
ml::Vector&
FeatureAnglesBtwPlanes::computeError( ml::Vector& res,int time )
{
  sotDEBUGIN(15);
  updateInputValues(Soutput_, time);
