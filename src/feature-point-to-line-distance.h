...
#ifndef __SOT_FEATURE_POINT_TO_LINE_DISTANCE_HH__
#define __SOT_FEATURE_POINT_TO_LINE_DISTANCE_HH__
...
#    define SOTFeaturePointToLineDistance_EXPORT __declspec(dllexport)
#  else
#    define SOTFeaturePointToLineDistance_EXPORT __declspec(dllimport)
#  endif
#else
#  define SOTFeaturePointToLineDistance_EXPORT
#endif
...
*/
class FeaturePointToLineDistance
...
public:
  FeaturePointToLineDistance( const std::string& name );
  virtual ~FeaturePointToLineDistance( void ) {}
