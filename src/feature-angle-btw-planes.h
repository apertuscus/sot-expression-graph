...
#    define SOTFeatureAnglesBtwPlane_EXPORT __declspec(dllexport)
#  else
#    define SOTFeatureAnglesBtwPlane_EXPORT __declspec(dllimport)
#  endif
#else
#  define SOTFeatureAnglesBtwPlane_EXPORT
#endif
...
public:
  FeatureAnglesBtwPlanes( const std::string& name );
  virtual ~FeatureAnglesBtwPlanes( void ) {}
