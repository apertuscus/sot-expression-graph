...
#include "feature-point-to-line-projection.h"
#include "helper.h"
...
DYNAMICGRAPH_FACTORY_ENTITY_PLUGIN(FeaturePointToLinePrj,"FeaturePointToLinePrj");

/* --------------------------------------------------------------------- */
/* --- CLASS ----------------------------------------------------------- */
/* --------------------------------------------------------------------- */

FeaturePointToLinePrj::
FeaturePointToLinePrj( const string& name )
...
unsigned int& FeaturePointToLinePrj::
...
ml::Matrix& FeaturePointToLinePrj::
