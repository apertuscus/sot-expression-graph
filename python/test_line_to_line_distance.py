...
lineline = FeatureLineToLineDistance('lineline')
pointpoint = FeaturePointToPoint('pointpoint')
lineline.displaySignals()
...
plug(robot.dynamic.signal(opPoint1),lineline.signal('w_T_o1'))
plug(robot.dynamic.signal('J'+opPoint1),lineline.signal('w_J_o1'))
plug(robot.dynamic.signal(opPoint2),lineline.signal('w_T_o2'))
plug(robot.dynamic.signal('J'+opPoint2),lineline.signal('w_J_o2'))
...
taskExpg.add(lineline.name)

#desired value
lineline.reference.value = 0
pointpoint.reference.value = 0.1

lineline.dir1.value= (1.0,  0.0, 0.0)
lineline.dir2.value= (1.0,  0.0, 0.0)
