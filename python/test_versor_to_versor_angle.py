...
versorversor = FeatureVersorToVersor('versorversor')
pointpoint = FeaturePointToPoint('pointpoint')
versorversor.displaySignals()
...
plug(robot.dynamic.signal(opPoint1),versorversor.signal('w_T_o1'))
plug(robot.dynamic.signal('J'+opPoint1),versorversor.signal('w_J_o1'))
plug(robot.dynamic.signal(opPoint2),versorversor.signal('w_T_o2'))
plug(robot.dynamic.signal('J'+opPoint2),versorversor.signal('w_J_o2'))
...
taskExpg.add(versorversor.name)

#desired value
versorversor.reference.value = 3.1
pointpoint.reference.value = 0.1  

versorversor.v1.value= (1.0,  0.0, 0.0)
versorversor.v2.value= (1.0,  0.0, 0.0)
